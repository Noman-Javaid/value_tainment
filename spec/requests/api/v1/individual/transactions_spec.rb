...
RSpec.describe 'Api::V1::Individual::TransactionsController', type: :request do
  let(:transaction_path) { api_v1_individual_transactions_path }
  ...
  context 'with valid authentication and authorization data' do
    ...
    describe 'GET /api/v1/individual/transactions' do
      before do
