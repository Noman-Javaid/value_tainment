...
class Expert::Calls::DeclineReschedulingRequest
    ...
    if time_left <= 24
      ...
      begin
        ActiveRecord::Base.transaction do
          ...
          # send declined notification to individual
          Notifications::Individuals::ExpertCallNotifier.new(expert_call).rescheduling_request_declined

          # send sms to individual
          individual_user = expert_call.individual.user
          expert_user = expert.user
          # send sms to individual
          individual_sms = I18n.t('api.expert_call.rescheduling.decline.message_to_individual',
          ...
          TwilioServices::SendUpdateBySms.call(individual_user, individual_sms, I18n.t('global.events.reschedule_request_declined')) if individual_user.phone_number.present?
          # send email to individual and expert
          CallReschedulingMailer.declined_by_expert(expert_call).deliver_later
        end
