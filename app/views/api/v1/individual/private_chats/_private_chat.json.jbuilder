json.extract! private_chat,
              ...
              :updated_at,
              :created_at
json.status_description private_chat.status_description(for_user: @individual)
...
json.has_new_message private_chat.has_new_message_for_user?(@individual)
json.un_read_messages_count private_chat.unread_message_count_for_user(@individual)
json.messages private_chat.messages, partial: 'api/v1/individual/messages/show_message', as: :message
