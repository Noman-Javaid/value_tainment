class Api::V1::Individual::ExpertCalls::ReschedulesController <
  ...
  def create
    reschedule_request = Individual::Calls::Reschedule.call(@individual, @expert_call, reschedule_params)
  ...
  def decline
    decline_reschedule_request = Individual::Calls::DeclineReschedulingRequest.call(@individual, @expert_call, @rescheduling_request)
  ...
  def accept
    accept_reschedule_request = Individual::Calls::AcceptReschedulingRequest.call(@individual, @expert_call, @rescheduling_request)
