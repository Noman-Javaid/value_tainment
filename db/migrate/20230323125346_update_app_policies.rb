class UpdateAppPolicies < ActiveRecord::Migration[6.1]
  def change
      ...
      expert_policies.each do |expert_policy|
        ...
        when 'Rescheduling Policy'
          expert_policy.update!(description: ['You may reschedule any time up to 24 hours before a call.',
                                              ...
                                              "If the user declines your request, or doesn't answer in time, the call is canceled and the user receives a full refund."])
